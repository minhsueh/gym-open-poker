...
class Player:
    ...
    def assign_hole_cards(self, cards):
        ...
        """
        if not cards:
            print('Error: cannot assign empty cards list to player')
            raise Exception
    ...
    def assign_to_fold(self, current_gameboard):
        ...
        print(f'{self.player_name} is assigned to fold')
        self.is_fold = True
        current_gameboard['board'].num_active_player_on_table -= 1
    ...
    def assign_to_all_in(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} is assigned to all-in')
        self.is_all_in = True
    ...
    def add_current_bet(self, amount, chips):
        ...
        """
        if amount < 0:
            print('Error: cannot add negative chips to current bet')
            raise Exception
    ...
    def reset_player_each_game(self, current_gameboard):
        ...
        if current_gameboard['cur_phase'] != 'concluding_phase':
            print(f'{self.player_name} are in wrong phase to reset each game')
            raise Exception
    ...
    def force_bet_small_blind(self, current_gameboard):  # what is number?
        ...
        if not self.small_blind:
            print(f'{self.player_name} is not small blind, and cannot force to bet...')
            raise Exception

        # small blind from $1 chip
        print(f'{self.player_name} is forced to bet ${current_gameboard["small_blind_amount"]} as small blind')
    ...
    def force_bet_big_blind(self, current_gameboard, time_raise_from_small_blind=2):
        ...
        if not self.big_blind:
            print(f'{self.player_name} is not big blind, and cannot force to bet...')
        ...
        print(f'{self.player_name} is forced to bet ${amount_for_big_blind} as big blind')
    ...
    def assign_small_blind(self, current_gameboard, assign_to=False):
        ...
        if not assign_to and not self.small_blind:
            print(f'{self.player_name} is already not small blind, something go wrong...')
            raise Exception
        elif assign_to and self.small_blind:
            print(f'{self.player_name} is already small blind, something go wrong...')
            raise Exception

        self.small_blind = assign_to
        print(f'{self.player_name} successfully set to small blind')
    ...
    def assign_big_blind(self, current_gameboard, assign_to=False):
        ...
        if not assign_to and not self.big_blind:
            print(f'{self.player_name} is already not big blind, something go wrong...')
            raise Exception
        elif assign_to and self.big_blind:
            print(f'{self.player_name} is already big blind, something go wrong...')
            raise Exception

        self.big_blind = assign_to
        print(f'{self.player_name} successfully set to big blind')
    ...
    def compute_allowable_turn_actions(self, current_gameboard):
        ...
        """
        # will be (check, bet, fold) and then (raise, call, fold) if everyone does not check
        print(f'{self.player_name} computes allowable turn round actions...')
        allowable_actions = set()
        allowable_actions.add(fold)
    ...
    def compute_allowable_river_actions(self, current_gameboard):
        ...
        """
        # will be (check, bet, fold) and then (raise, call, fold) if everyone does not check
        print(f'{self.player_name} computes allowable river round actions...')
        allowable_actions = set()
        allowable_actions.add(fold)
    ...
    def compute_allowable_computing_best_hand_actions(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} computes allowable best hand actions...')
        allowable_actions = set()
    ...
    def compute_allowable_continue_game_actions(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} computes allowable continue game actions...')
        allowable_actions = set()
        allowable_actions.add(fold)
    ...
    def make_pre_flop_moves(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} currently in pre-flop round')
    ...
    def make_flop_moves(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} currently in flop round')
    ...
    def make_turn_moves(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} currently in turn round')
    ...
    def make_river_moves(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} currently in river round')
    ...
    def make_computing_best_hand_moves(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} currently is computing best hand')
    ...
    def make_continue_game_moves(self, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} currently is in continue game moves')
    ...
    def _execute_action(self, action_to_execute, parameters, current_gameboard):
        ...
        :return:
        """
        print(f'{self.player_name} executes its _execute_action function')
        if parameters:
