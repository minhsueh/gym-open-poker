...
class Action1(gym.Wrapper):
    ...
    def __init__(self, env):
        ...
        super().__init__(env)
        sys.modules['player'].Player.compute_allowable_pre_flop_actions = \
            getattr(sys.modules[__name__], '_alter_compute_allowable_pre_flop_actions')
        sys.modules['player'].Player.compute_allowable_flop_actions = \
            getattr(sys.modules[__name__], '_alter_compute_allowable_flop_actions')
        sys.modules['player'].Player.compute_allowable_turn_actions = \
            getattr(sys.modules[__name__], '_alter_compute_allowable_turn_actions')
        sys.modules['player'].Player.compute_allowable_river_actions = \
            getattr(sys.modules[__name__], '_alter_compute_allowable_river_actions')
