...
class Event1(gym.Wrapper):
    ...
    def __init__(self, env):
        ...
        super().__init__(env)
        sys.modules["dealer"].check_and_deal_community_card = getattr(
            sys.modules[__name__], "_alter_check_and_deal_community_card"
        )
...
def _alter_check_and_deal_community_card(current_gameboard):
    ...
    if condition1 and condition2 and condition3:
        ...
        community_cards = current_gameboard["board"].deck[
            current_gameboard["board"].deck_idx : current_gameboard["board"].deck_idx + num_cards_to_deal
        ]
        current_gameboard["board"].assign_deck_idx(num_cards_to_deal)
